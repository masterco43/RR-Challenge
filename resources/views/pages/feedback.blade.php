                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('feedback')}}" method="POST" name="feedback_form">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" id="nameInput" name="name" placeholder="Enter Name">
                            </div>
                            <div class="form-group">
                                <label for="emailInput" style="font-weight: bold;">E-mail Address <span class="required" style="">*</span></label>
                                <input required type="email" class="form-control" id="emailInput" name="email" placeholder="Enter E-mail">
                            </div>
                            <div class="form-group">
                                <label for="commentInput" style="font-weight: bold;">Questions / Comments <span class="required" style="">*</span></label>
                                <textarea required class="form-control" id="commentInput" name="comments" placeholder="Enter Questions/Comments" rows="4" onkeyup="changeCounter()" maxlength="200"></textarea>
